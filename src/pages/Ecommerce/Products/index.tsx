...
import { getProductss } from "slices/companies/thunk";
...
const AllProducts = (props: any) => {
  ...
  const products = useSelector(slectedCompanies);
  ...
  useEffect(() => {
    setCompaniesList(products);
  }, [products]);

  useEffect(() => {
    if (!isEmpty(products)) setCompaniesList(products);
  }, [products]);
        ...
        return (
          <UncontrolledDropdown>
            ...
            <DropdownMenu className="dropdown-menu-end">
              ...
              <DropdownItem href={`UpdateProduct?id=${cell.row.original._id}`}>
